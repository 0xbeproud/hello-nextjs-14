...
function About() {
    ...
    return (
        <>
            {isDesktop? <div className="bg-emerald-400 text-sm">
                userAgent: {userAgent} <br/>
                isAndroid: {isAndroid.toString()}<br/>
                isIOS: {isIOS.toString()}<br/>
                isOpera: {isOpera.toString()}<br/>
                isWindows: {isWindows.toString()}<br/>
                isSSR: {isSSR.toString()}<br/>
