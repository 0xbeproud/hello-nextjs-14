...
const SuperCycleSlide = () => {
    return <SlideContainer bgImage={SuperCycleImage}>
        <Wrapper className="flex flex-row flex-wrap justify-start">
            ...
            <Summary>
                Sustainable consumption is not only about the continued utilization of resources, <br/>
                but also about achieving sustainable social development through ethical consumption. <br/>
                It is about restoring the relationship between people and nature and people and people. <br/>
            </Summary>
        </Wrapper>
    </SlideContainer>
}
