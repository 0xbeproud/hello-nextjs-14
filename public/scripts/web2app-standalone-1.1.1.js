...
;(function (exports) {
  ...
  (function () {
    ...
    if (typeof exports === 'object') {
      ...
      window.daumtools =
        typeof window.daumtools === 'undefined' ? {} : window.daumtools
      window.util =
        typeof window.util === 'undefined' ? window.daumtools : window.util
      return window.daumtools
    } else if (typeof self === 'object') {
      // for use in web workers
      self.daumtools =
        typeof self.daumtools === 'undefined' ? {} : self.daumtools
...
;(function (exports) {
  ...
  exports.daumtools =
    typeof exports.daumtools === 'undefined' ? {} : exports.daumtools
